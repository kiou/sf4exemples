...
final class Version20181212104759 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE type (id INT AUTO_INCREMENT NOT NULL, galerie_id INT DEFAULT NULL, created DATETIME NOT NULL, changed DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_8CDE5729825396CB (galerie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE type ADD CONSTRAINT FK_8CDE5729825396CB FOREIGN KEY (galerie_id) REFERENCES galerie (id)');
