 ...
 */
final class Version20181211134629 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE galerie_categorie (galerie_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_ABBF71DE825396CB (galerie_id), INDEX IDX_ABBF71DEBCF5E72D (categorie_id), PRIMARY KEY(galerie_id, categorie_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
