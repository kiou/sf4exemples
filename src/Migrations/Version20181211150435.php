 ...
 */
final class Version20181211150435 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE categorie_galerie (categorie_id INT NOT NULL, galerie_id INT NOT NULL, INDEX IDX_C1FEBB32BCF5E72D (categorie_id), INDEX IDX_C1FEBB32825396CB (galerie_id), PRIMARY KEY(categorie_id, galerie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
